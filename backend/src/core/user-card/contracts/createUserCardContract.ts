...
/**
 * CreateUserCardContract - Contrato para crear una tarjeta de usuario
 *
 ...
 */
export const CreateUserCardContract = z.object({
  userId: z
...
export type CreateUserCardContract = z.infer<typeof CreateUserCardContract>;
